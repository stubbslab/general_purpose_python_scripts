...
class CosmologicalCalculator:
    ...
    def getTsFromZs(self, zs):
        ...
        print ('Cosmological calculator computed ts from zs. ')
        return ts
    ...
    def getTausFromZs(self, zs):
        ...
        print ('Cosmological calculator computed taus from zs. ')
        return taus
    ...
    def __init__(self, zs = None, ts = None, a_params = None, use_canon_params = 1, H_funct = 'standard', H0 = 70.0, OmM = 0.3, OmL = 0.7, Om0 = 1.0, OmR = 0.00001 * 8.413):
