...
def polyFitNSigClipping(full_x_data, full_y_data, fit_order, sig_clipping,
    ...
    y_errs = full_y_errs
    new_fit = None
    while still_outliers and fit_not_stable:
        prev_fit = new_fit
...
def readInColumnsToList(file_name, file_dir = '', n_ignore = 0, delimiter = ' ', convert_to_float = 0, convert_to_int = 0, ignore_line_char = None, col_indeces = 'all', verbose = 1, all_np_readable = 0):
    """
